...
T41|~|organism IK walker rewrite (Smitner-informed, user repo 2026-07-21): kinematic FABRIK limbs + explicit foot targets + swing arcs + traveling perpendicular waves; DONE core rewrite; OPEN: travel stalls mid-route (parked 0.66 pursue), gait cadence tuning, wave amp/freq taste pass|C14,V19
T42|.|organism aesthetic punch list (user 2026-07-21): interior depth shading taste pass (internalShadingStrength), webbing vs free-tentacle balance, seeker extension feel, silhouette review session w/ user in lab|C14
